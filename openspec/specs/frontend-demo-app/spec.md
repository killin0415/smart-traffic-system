...
Defines the demo frontend single-page application (Vite + React 19 + TypeScript + Tailwind CSS + zustand + react-leaflet) that consumes main-service REST endpoints to provide an interactive map, route planning form, and chat panel for the smart traffic demo.
